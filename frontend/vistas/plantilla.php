...
if(isset($_GET["ruta"])){
	...
	}else if($rutas[0] == "buscador" || $rutas[0] == "verificar" || $rutas[0] == "salir" || $rutas[0] == "perfil" || $rutas[0] == "facturacion" || $rutas[0] == "carrito-de-compras" || $rutas[0] == "error" || $rutas[0] == "finalizar-compra" || $rutas[0] == "curso"){
...
<script type="text/javascript" style="">
    (function () {
        var options = {
            ...
            whatsapp: "+52 1 55 8794 6703", // WhatsApp number
            email: "samm.arquitectura@hotmail.com", // Email
