					...
					$(".cuerpoCarrito").append(
						...
						'<div clas="row itemCarrito">'+
							...
							'<div class="col-md-2 col-sm-1 col-xs-12">'+
								...
								'<p class="precioCarritoCompra text-center">MX $<span>'+precio+'</span></p>'+
							...
							'<div class="col-md-2 col-sm-1 col-xs-4 text-center">'+
								...
								'<p class="subTotal'+index+' subtotales">'+
									...
									'<strong>MX $<span>'+(Number(item.cantidad)*Number(precio))+'</span></strong>'+
...
$("#cambiarDivisa").change(function(){
	...
	$.ajax({
		...
		url: "https://free.currconv.com/api/v7/convert?q="+divisaBase+"_"+divisa+"&compact=ultra&apiKey=631a2ee7118a10541b4b",
		type:"GET",
		cache: false,
	    contentType: false,
	    processData: false,
