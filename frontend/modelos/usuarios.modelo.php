...
class ModeloUsuarios{
	...
	static public function mdlRegistroUsuario($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, password, email, foto, modo, verificacion, emailEncriptado, emailfac, nombrefiscal, cp, rfc, regimenfiscal, correofact) VALUES (:nombre, :password, :email, :foto, :modo, :verificacion, :emailEncriptado, :emailfac, :nombrefiscal, :cp, :rfc, :regimenfiscal, :correofact)");
		...
		$stmt->bindParam(":correofact", $datos["correofact"], PDO::PARAM_STR);																	
	...
	static public function mdlActualizarPerfil($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, email = :email, password = :password, foto = :foto, emailfac = :emailfac, nombrefiscal = :nombrefiscal, cp = :cp, rfc = :rfc, regimenfiscal = :regimenfiscal, correofact = :correofact   WHERE id = :id");
